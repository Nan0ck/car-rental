...
<head>
  ...
  <title>TitoCar - Cars by Location</title>
...
<body>
  ...
  $sql = "CALL getCarsByCountry('" . $_SESSION["country"] . "')";
  ...
  <div id="information" class="container">
    <div class="row">
      ...
      <div class="col-md-8 ">
        <div class="panel panel-default">
          <div class="panel-heading panel-heading-custom" >
            <h3 class="panel-title">All Cars in : <?php echo $country ?></h3>
          </div>
          <div class="panel-body">
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  while($row = $result->fetch_assoc()) {
                    array_push($_SESSION["cars"],array($row["image"], $row["rental"] ,$row["type"],$row["brand"],$row["model"],$row["priceDay"], $row["fuelType"], $row["yearCar"]));
                    ?>
                    <form class="" action="driverInformation.php" method="post">

                      <tr>
                        <td><label class="rental"><?php echo $row["rental"]; ?></label></td>
